...
class LinkTransformerLayer(nn.Module):
    ...
    def __init__(
        ...
        self.post_att_norm = nn.LayerNorm(out_dim * train_args.num_heads_l if concat else out_dim)
    ...
    def forward(self, edge_index, edge_x, node_x, pe_enc=None, deg_enc=None, return_weights=False):
        ...
        # TODO: !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        e1, e2 = edge_x.chunk(2, dim=-1)
        out = self.lin(e1 + e2 + out)
        # out = e1 + e2 + out
...
class LinkAttention(MessagePassing):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.heads = train_args.num_heads_l
        self.concat = concat
